% Troca uma posiçao
function [s_viz_sol,s_viz_fobj,s_viz_crit]= est_viz1_altern_hash_t(s_tupla)
...
%  [fobj_central,crit_central]= eval_solution(H_temp,H,w_k,nm);
    ...
    for i=1:length(ativas)
       ...
       for j=1:length(n_ativas) 
          ...
          vizinho(n_ativas(j))=0; % desativa atual
